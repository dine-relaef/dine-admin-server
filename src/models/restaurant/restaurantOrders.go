...
type Order struct {
	...
	Restaurant    models.Restaurant `gorm:"foreignKey:RestaurantID" json:"-"`
...
type OrderItem struct {
	...
	MenuItem       models.MenuItem       `gorm:"foreignKey:MenuItemID" json:"-"`
	...
	ItemOption     models.MenuItemOption `gorm:"foreignKey:ItemOptionID" json:"-"`
