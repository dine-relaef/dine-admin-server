...
// @Produce json
// @Param id path string true "User ID"
// @Param user body models.UpdateUserDataByAdmin true "User data"
// @Security ApiKeyAuth
...
// @Tags User
// @Produce json
// @Param user body models.UpdateUserDataByUser true "User data"
// @Security ApiKeyAuth
...
func UpdateUserByUser(c *gin.Context) {
	...
	var input models.UpdateUserDataByUser
	if err := c.ShouldBindJSON(&input); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
